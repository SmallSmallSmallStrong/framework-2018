...
public class VerificationCodeUtil {
     ...
     * 功能：设置第二种验证码属性
     */
    private void initLetterAndNumVerificationCode(BufferedImage image) {
     ...
     */
    private void initChinesePlusNumVerificationCode(BufferedImage image) {
    ...
    private void setImage(ByteArrayInputStream image) {
        this.image = image;
    }
    ...
    public static void main(String[] arg) {
       ...
       System.out.println(vcu);
        vcu.getStr();// str
        ByteArrayInputStream bais  = vcu.getImage();
        
        bais.read();
       System.out.println(bais);
        System.err.println(vcu.getVerificationCodeValue());//输出验证码的实际值
        try {
            System.out.println(bais.available());
            System.out.println(bais.read(new byte[bais.available()]));
        } catch (IOException e) {
            e.printStackTrace();
        }
