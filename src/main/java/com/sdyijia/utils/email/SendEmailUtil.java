...
public class SendEmailUtil {
    ...
    public static void sendEmail(String receiveMailAccount, String receiveMailTitle, String receiveMailContent) throws Exception {
        ...
        props.setProperty("mail.transport.protocol", emailini.getEmailTransportProtocol()); // 使用的协议（JavaMail规范要求）
        props.setProperty("mail.smtp.host", emailini.getEmailSMTPHost()); // 发件人的邮箱的SMTP服务器地址
        props.setProperty("mail.smtp.auth", emailini.getEmailAuth()); // 需要请求认证
        ...
        MimeMessage message;
        // 3. 创建一封邮件
        message = createMimeMessage(session, emailini.getEmailAccount(), receiveMailAccount, receiveMailTitle,
                receiveMailContent);
        ...
        transport.connect(emailini.getEmailAccount(), emailini.getEmailPassword());
    ...
    private static MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail,
        ...
        // FileDataSource("FairyTail.jpg")); // 读取本地文件
        ...
        // text.setContent("这是一张图片<br/><img src='cid:image_fairy_tail'/>",
        ...
        // DataHandler dh2 = new DataHandler(new FileDataSource("妖精的尾巴目录.doc"));
        // // 读取本地文件
