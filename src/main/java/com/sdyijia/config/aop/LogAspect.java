package com.sdyijia.config.aop;

import com.sdyijia.config.aop.bean.LogAdmModel;
import com.sdyijia.config.aop.manager.ILogManager;
import com.sdyijia.config.aop.type.EventType;
import com.sdyijia.config.aop.type.ModuleType;
...
public class LogAspect {
    ...
    //TODO 如果修改包名请修改这里
    @Pointcut("execution(* com.sdyijia..*.*(..))")
    ...
    public Object aroundManagerLogPoint(ProceedingJoinPoint jp) throws Throwable {
        ...
        logInfoGeneration.processingManagerLogMessage(jp, logBean, method);
